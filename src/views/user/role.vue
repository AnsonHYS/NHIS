    ...
    <el-dialog :title="textMap[dialogStatus]"
      ...
      <el-form class="small-space"
        ...
        <el-form-item label="菜单&权限"
                      required>
          <div v-for=" (menu,_index) in allPermission"
               :key="menu.menuName">
            <span style="width: 100px;display: inline-block;">
              <el-button :type="isMenuNone(_index)?'':(isMenuAll(_index)?'success':'primary')"
                         size="mini"
                         style="width:80px;"
      ...
      <div slot="footer"
        ...
        <el-button v-if="dialogStatus=='create'"
                   type="success"
                   @click="createRole">创 建</el-button>
        <el-button type="primary"
                   v-else
                   @click="updateRole">修 改</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
.role .el-table__header th {
  background-color: #337da8 !important;
}
.role .el-table td .el-table th.is-leaf {
